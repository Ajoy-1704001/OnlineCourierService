                    ...
                    if(productAllData!=null){
                        firebaseFirestore.collection("Merchants").document(productAllData.getId()).addSnapshotListener(new EventListener<DocumentSnapshot>() {
                            ...
                            public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                                    if(value!=null){
                                        productModels.add(new ProductModel(keyNode.getKey(),productAllData.getProduct_name(),value.getString("businessName"),productAllData.getProduct_price(),productAllData.getImage_url()));
